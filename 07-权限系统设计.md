...
pub struct RoomMember {
    ...
    pub banned_by: Option<String>,  // nanoid(12)
...
pub async fn set_member_permissions(
    Extension(user): Extension<User>,
    Extension(room): Extension<Room>,
    Path(member_id): Path<String>,  // nanoid(12)
...
CREATE TABLE room_settings (
    id CHAR(12) PRIMARY KEY REFERENCES rooms(id) ON DELETE CASCADE,
...
CREATE TABLE permission_change_logs (
    id CHAR(12) PRIMARY KEY,
    room_id CHAR(12) NOT NULL REFERENCES rooms(id) ON DELETE CASCADE,
    target_user_id CHAR(12) NOT NULL REFERENCES users(id),
    changed_by CHAR(12) NOT NULL REFERENCES users(id),
